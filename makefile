...
_DEPS = OLDpermutations.h OLDfunctions.h OLDOptions.h EncryptionParameters.h CryptOption.h
...
_OBJ = OLDdes.o OLDfunctions.o OLDpermutations.o EncryptionParameters.o CryptOption.o
