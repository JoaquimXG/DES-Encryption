...
void getkey(std::string key, unsigned (*keya)[16][48]);//takes a key as input and generates the keys required for certain encryption algorithms
...
int parseCommandLineArguments(int argc, char* argv[], Options* encryptOpts, bool decrypt=false);
